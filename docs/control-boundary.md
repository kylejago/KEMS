...
`binary_sensor.kems_control_commands_permitted` remains off in alpha1. The real backend will be added only after installation-day entity/service mapping, sign validation, command verification, and controlled outage testing.
