...
KEMS 0.7.0-alpha5 calculates the exact desired behaviour of the proposed KH7 system without sending real inverter commands.
...
- `control`: visible in the options flow, but real commands remain hard-blocked in alpha5.
