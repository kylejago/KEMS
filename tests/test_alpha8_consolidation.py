...
def test_current_release_family_is_coordinated() -> None:
    ...
    assert manifest["version"] == "0.9.0-alpha9.41"
    ...
    assert 'PANEL_CONFIG_VERSION = "0.9.0-alpha9-panel.3"' in panel_manager
    assert 'panel_config_version: "0.9.0-alpha9-panel.3"' in panel_yaml
