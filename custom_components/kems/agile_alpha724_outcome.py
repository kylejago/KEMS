...
def install_alpha724_outcome_parity_patch() -> None:
    ...
    if alpha723.build_agile_shadow_command is not build_agile_shadow_command_with_outcome_parity:
        alpha723.build_agile_shadow_command = build_agile_shadow_command_with_outcome_parity
